    ...
    public partial class XMSSCData2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //Get CloseDate
                string CloseDate = xmsscdata.SC_GetCloseDate("3PL");
                lbl_CLoseDate.Text = CloseDate;
            }
        }
        ...
        protected void btn_Query_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.Parse(dates) < DateTime.Parse(lbl_CLoseDate.Text))
            {
                ErrMsg += "不可小於關帳日期";
            }
            if (dates == "")
