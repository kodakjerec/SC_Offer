...
namespace SC_Offer
{
    public partial class SCQuoteItem : System.Web.UI.Page
    {
        ...
        protected void btn_Print_Click(object sender, EventArgs e)
        {
            ...
            string Path = DAO.GetSC_Offer_FunList_PgN("EDI","WMSS008");
            string ParameterLink="&Object_No=" + strObj + "&offer_No_Ext=" + strSCNO + "&Contract_Ares=" + strDC;
            Response.Write("<script>window.open('" + Path +ParameterLink+ "' ,'','height=600,width=800,scrollbars=yes,menubar=no,location=no');</script>");
